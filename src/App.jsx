...
function App() {
  ...
  const words = ["'by the horizons.'", "'by abhay.'", "'with gratitude.'"];
          ...
          <section className="words-section reveal-section" id="words" ref={addToRefs}>
            ...
            <div className="testimonials-grid">
              <div className="testimonial-card">
                <div className="quote-icon"><svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="4" width="18" height="24" rx="3" stroke="#0ea5e9" strokeWidth="2.5"/><path d="M12 28v4a8 8 0 0 1-8 8" stroke="#0ea5e9" strokeWidth="2.5" strokeLinecap="round"/><rect x="28" y="4" width="18" height="24" rx="3" stroke="#0ea5e9" strokeWidth="2.5"/><path d="M38 28v4a8 8 0 0 1-8 8" stroke="#0ea5e9" strokeWidth="2.5" strokeLinecap="round"/></svg></div>
                ...
                <div className="testimonial-author">
                  <div className="author-avatar"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></div>
